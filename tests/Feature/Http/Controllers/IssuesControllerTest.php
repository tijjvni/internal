...
/**
 * @see \App\Http\Controllers\IssuesController
 */
class IssuesControllerTest extends TestCase
{
    ...
    {
        $issues = Issues::factory()->count(3)->create();
    ...
    public function store_uses_form_request_validation()
    {
        $this->assertActionUsesFormRequest(
            \App\Http\Controllers\IssuesController::class,
            'store',
            \App\Http\Requests\IssuesStoreRequest::class
        );
    }
